...
public final class Sphere {
    ...
    public Sphere(Context context, float f, boolean z, int i, int i2) {
    ...
    private void computeAndBuildData(float f, int i, int i2) {
        ...
        for (int i7 = 0; i7 < i2; i7 += PLANET_BLEND_MODE_NONE) {
            double d = 3.141592653589793d * (0.5d - (((double) (i7 + 0)) / ((double) i2)));
            double d2 = 3.141592653589793d * (0.5d - (((double) (i7 + PLANET_BLEND_MODE_NONE)) / ((double) i2)));
            double cos = Math.cos(d);
            d = Math.sin(d);
            double cos2 = Math.cos(d2);
            d2 = Math.sin(d2);
            for (int i8 = 0; i8 < i; i8 += PLANET_BLEND_MODE_NONE) {
                double d3 = -3.141592653589793d + ((6.283185307179586d * ((double) i8)) * (1.0d / ((double) (i - 1))));
                double cos3 = Math.cos(d3);
                d3 = Math.sin(d3);
                fArr[i3 + 0] = ((float) (cos2 * cos3)) * f;
                fArr[i3 + PLANET_BLEND_MODE_NONE] = ((float) (cos2 * d3)) * f;
                fArr[i3 + PLANET_BLEND_MODE_ATMO] = ((float) d2) * f;
                fArr[i3 + PLANET_BLEND_MODE_SOLID] = ((float) (cos * cos3)) * f;
                fArr[i3 + PLANET_BLEND_MODE_FADE] = ((float) (cos * d3)) * f;
                fArr[i3 + 5] = ((float) d) * f;
                fArr3[i4 + 0] = (float) (cos2 * cos3);
                fArr3[i4 + PLANET_BLEND_MODE_NONE] = (float) (cos2 * d3);
                fArr3[i4 + PLANET_BLEND_MODE_ATMO] = (float) d2;
                fArr3[i4 + PLANET_BLEND_MODE_SOLID] = (float) (cos3 * cos);
                fArr3[i4 + PLANET_BLEND_MODE_FADE] = (float) (d3 * cos);
                fArr3[i4 + 5] = (float) d;
                if (this.withTexture) {
